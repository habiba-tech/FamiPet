...
\begin{itemize}
    ...
    \item the React frontend application (\path{frontend-react/}) with TypeScript,
    Vite, and Tailwind CSS;
    \item project documentation, including this black book, the development
    roadmap (\path{ROADMAP.md}), and the
    maintenance rules in \path{AGENTS.md};
...
of writing, the backend is feature-complete and the React frontend implements
roadmap phases 1--22, while phases 23--29 remain planned
