...
FamiPet uses MongoDB as its primary store. The schema is defined in thirteen
Mongoose models, all located in \texttt{backend/models/}. Figure~\ref{fig:er}
...
(checkup/vaccination/surgery/emergency/grooming/consultation), status
(pending/confirmed/completed/cancelled/no-show), symptoms, notes, prescription,
diagnosis, fee, isPaid. \\
Notification & \texttt{notifications} & user, title, message, type
(adoption/appointment/vaccination/health/system/other), isRead. \\
